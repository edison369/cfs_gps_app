...
#define GPS_APP_BUILD_NUMBER 35 /*!< Development Build: Number of commits since baseline */
...
#define GPS_APP_MINOR_VERSION 1  /*!< @brief Minor version number. */
#define GPS_APP_REVISION      99 /*!< @brief Revision version number. Value of 99 indicates a development version.*/
